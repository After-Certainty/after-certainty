...
The school could not stop operating while the parent group searched for a perfect pickup system.
...
At work, the launch decision still had to be made.

The milestone had already moved twice. The latest vendor response was open on the screen. They had forty minutes before the recommendation had to go to the director.

Philip stood at the whiteboard. "What does everyone believe we are deciding right now?"

The room had entered believing it faced one decision. It was carrying at least three. Nora wrote them separately: whether to proceed with the workaround; whether to change the milestone; whether to continue investing in the secondary path.
...
Anna said the workaround could proceed, but only if the team stopped describing it as proof that the secondary path was viable. "The workaround buys us time. It does not answer the vendor question."
...
Philip recommended the workaround, a milestone one week beyond the original date, and continued funding of the secondary path until the missing validation arrived. Before the recommendation became the team's decision, each person named what remained unresolved. Nora recorded the list and the reassessment conditions:
...
The program manager read the draft. "This sounds uncertain."

"We are uncertain," Anna said.

Philip let the uncertainty travel upward under his name. The director called. He explained the delay without converting several distinct judgments into a posture of confidence. One week. No more.

Three days later, the vendor responded. The reassessment condition had been met. Because it had been recorded before the answer arrived, the team could revise without first proving that doubt had ever been present.
...
When uncertainty remains visible, correction has somewhere to land. When conditions are recorded, responsibility can follow the decision through time. When people with greater power to close the meaning bear some of the cost of staying open, others do not have to carry all of it privately.
