...
Reachability is the condition in which a settled interpretation has not consumed every path back to revision.

It does not require agreement, reconciliation, forgiveness, or continued access. It requires only that later truth can still matter—that a person, relationship, or record has preserved enough contact for new information to alter what the earlier meaning is allowed to become.

Connection keeps lives consequentially coupled. Contact keeps interpretation near what was said and what remains unresolved. Restraint keeps the first reading from spending all the relational credit available.

Reachability is what sometimes survives when those forces have done enough—not to prevent meaning from hardening, but to leave it somewhere to return.
