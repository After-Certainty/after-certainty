...
Distortion under authority does not require evil intent. It grows out of loud signal plus fast compression. Someone speaks. Others decide quickly what counts, what is safe, and what will be rewarded. Under hierarchy, people often settle on a read sooner not only from agreement but from risk management—trying to align with what they believe authority expects before openly testing whether they heard it correctly. The read locks before slow correction can catch it. When Philip finally spotted the drift, it was already baked into how work ran.[^c6-weick-sensemaking]
