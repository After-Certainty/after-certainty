...
## Legacy manuscript (pre–Option B rewrite)

The prior 14-chapter structure remains in the repository for passage mapping and merge reference:
...
- `front-matter/preface-before-understanding.md`
- `front-matter/introduction-why-communication-fails-before-anyone-is-wrong.md`
- `front-matter/how-to-read-this-book.md`

Retire these paths after the essayistic rewrite is complete.
