# Citation Audit — *The Economy We Don't Experience*

**Purpose:** Map every existing manuscript citation to a rewrite destination. Do not delete citations merely because surrounding prose is rewritten.  
**Factual cutoff:** retain **2020–2024** (and cited post-2008 institutional history) unless a later phase authorizes updates.  
**Format:** production uses Pandoc footnotes `[^id]` + Chicago-style [`back-matter/bibliography.md`](../../back-matter/bibliography.md).

**Status keys for “Source quality”:** Complete | Needs precision | Provisional / incomplete | Umbrella (agency range) | Missing from bibliography

**Example type keys:** Documentary | Composite / illustrative | Hypothetical | Mixed
...
No footnotes. Orientation only. No citation migration required.
...
## Chapter 2 — The Forecast Era That Didn't Break
...
## Chapter 3 — The Economy We Experience
...
## Chapter 4 — Why Pain Always Scales
...
## Chapter 5 — Resonance Without Understanding
...
## Chapter 6 — Leadership Under Interpretive Stress
...
## Chapter 7 — Elections Without Shared Understanding
...
## Chapter 8 — Resilience, Reform, and Forgotten Guardrails
