...
The original employment release may contain uncertainty, sector detail, and revisions. The headline contains a number. The campaign contains a verdict. By the time the report reaches the public argument, a map has become a flag.[^c1-shiller] This is how explanation slides toward signaling.
...
[^c1-shiller]: Robert J. Shiller, *Narrative Economics: How Stories Go Viral and Drive Major Economic Events* (Princeton: Princeton University Press, 2019).
