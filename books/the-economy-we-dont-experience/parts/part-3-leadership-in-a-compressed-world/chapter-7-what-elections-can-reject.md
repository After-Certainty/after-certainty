...
That model assumes at least a rough agreement about what happened. The agreement has weakened.

Two voters can look at the same inflation report and disagree not only about whether conditions are acceptable, but about what the report means.[^c7-bls-shed] One sees a declining rate of inflation and evidence that policy is working. Another sees prices that remain permanently higher and evidence that officials are manipulating language. One sees low unemployment. Another sees reduced hours, weaker bargaining power, or a job search that has taken months. One sees a resilient financial system. Another sees credit-card rates, mortgage payments, and small-business borrowing costs that closed off opportunities.

The disagreement is not always between facts and feelings. It is often between facts chosen from different scales. Campaigns rarely resolve this difference. They organize it. One side selects the chart that shows improvement. The other selects the receipt that shows pain. Each presents its evidence as the more honest view of the country. Each treats the other’s evidence as incomplete in a way that reveals bad faith.
...
These questions are difficult to answer through white papers. They are answered through tone, biography, setting, repetition, and the candidate’s willingness to name what other leaders minimized. Campaigns understand this. They place candidates beside grocery carts, factory gates, family businesses, construction sites, and kitchen tables because those settings carry relational credibility. The candidate borrows the authority of the object. The receipt is real. The closed storefront is real. The worker’s schedule is real. The campaign asks the voter to transfer that reality to the candidate’s explanation.

Sometimes the explanation deserves the transfer. Sometimes it does not. A candidate can recognize housing pain and offer a policy that would worsen supply. A candidate can understand that a community lost industrial work and still misrepresent why the work disappeared. A candidate can correctly perceive distrust and use it to weaken institutions that remain necessary. Recognition improves the chance of being heard. It does not guarantee the capacity to govern.
...
The coalition holds because its members share a refusal: not this; not them; not another term of being told conditions are better than they feel. This is enough to win an election. It is not enough to define success afterward.

A campaign can compress many grievances into a single message: the people in charge have failed you. The sentence allows voters to attach their own explanation. Its vagueness is part of its strength. The renter hears housing. The business owner hears credit and compliance. The worker hears wages and security. The retiree hears prices and taxes. They vote together without agreeing about which problem has priority or which remedy should come first.

The victory is then described as a mandate. Mandate is one of the cleanest words in democratic language. It implies that the public has spoken with enough clarity to authorize a direction. But elections often produce expressive mandates rather than interpretive ones. The public has expressed anger. It has expressed distrust. It has rejected a leader, party, tone, or trajectory. It may not have reached agreement about the mechanism beneath the problem.

A mandate can therefore be politically real and substantively thin. The winner has authority to act. The coalition has not necessarily agreed what action means.

### **The Promise Hidden in the Rejection**

Every rejection contains an implied promise. If the current leaders caused the pain, replacing them should reduce it. If the problem was incompetence, competent leadership should produce visible improvement. If the problem was betrayal, a leader who truly sees the public should govern differently.

Campaign rhetoric can keep these promises broad because broad promises allow more people to hear what they need: We will bring prices down. We will restore opportunity. We will make housing affordable. We will protect jobs. We will stop the decline. The phrases identify direction without specifying the clock. How soon? Through which mechanism? At whose expense? Compared with which baseline?

The ambiguity helps build the coalition. It becomes dangerous in office. Prices can fall because demand collapses, an outcome few voters would regard as prosperity. Housing can become more affordable through construction that existing residents oppose. Interest rates can decline because inflation is under control or because the economy has weakened. Jobs can be protected through subsidies, tariffs, procurement, training, migration policy, labor rules, or acceptance of higher consumer costs. Each remedy distributes benefits and burdens differently.

The campaign can postpone these conflicts by treating opposition as agreement. Governing cannot. Once in office, the leader must choose among the explanations that the campaign allowed to coexist. That choice will disappoint someone who believed the rejection carried a different promise. The coalition that agreed about what had to end discovers it did not agree about what should begin.
...
Recognition arrived in a sentence. Repair arrives through institutions. The clocks separate quickly. Supporters expect confirmation that their interpretation was correct. Opponents search for evidence that the campaign was dishonest. Journalists compare early actions with broad promises. Markets react before policies have had time to work.
...
The leader who abandons recognition after winning teaches voters that empathy was a campaign technology. The leader who preserves it has a chance to make patience feel different from neglect.

### **Vibes and Betrayal Risk**
...
A voter may know little about the details of a candidate’s tax plan and still possess a developed sense of which institutions are likely to protect people like her. That sense may be distorted by misinformation, identity, selective exposure, or prejudice. It may also be based on real encounters with systems that failed. The voter is using a heuristic. All voters do. No one evaluates every policy model, institutional constraint, and economic counterfactual before entering the booth. People rely on parties, endorsements, identities, memories, and trusted messengers to reduce complexity.
...
Vibes become a judgment about betrayal risk: Which side is more likely to lie to me? Which side sees people like me? Which side will use my hardship as a footnote? The judgment can be wrong. It is not empty. Dismissing it deepens the very credibility gap that produced it.[^c7-pew]

### **Procedures Without Shared Meaning**
...
A campaign can say restore manufacturing. A government must decide which industries, through what combination of trade policy, tax policy, training, infrastructure, and consumer cost. A candidate can say stop waste. An administration must identify which programs are unnecessary and which only look unnecessary because the crisis that created them has faded from memory.
...
The temptation is to create new enemies. If the promised outcome has not arrived, someone must be obstructing it: bureaucrats, courts, markets, corporations, local governments, foreign actors, the opposition, or disloyal members of the coalition. Sometimes obstruction is real. But blame can also preserve the campaign story after governing has exposed its incompleteness.

The outsider identity survives inside power. The leader remains the person fighting the system even while directing part of it. This can maintain relational credibility for a time. It makes accountability difficult. Every failure belongs to an enemy. Every success confirms the leader’s singular insight. A movement built on rejection becomes unable to update because updating would require admitting that the rejected system contained constraints the campaign did not understand.

The election has been won. The explanation remains oppositional.
...
The work after the vote is interpretive as well as political. Leaders must explain which promise they are pursuing, which mechanism they believe will work, which costs will arrive first, and what evidence would cause them to change course. They must continue seeing the people whose pain brought them to power. They must also tell those people when recognition does not validate the simplest explanation.

That is the difficult transition from coalition to governance. A ballot can compress many meanings into one decision. The decision is real. The agreement beneath it may be partial.

Elections can tell us what people refuse before they tell us what they are prepared to build.

[^c7-composite]: The neighbors, candidates, and election scenes in this chapter are composites constructed to illustrate recurring patterns in economic voting, campaign communication, and governing after an expressive mandate. They are not presented as documentary accounts of identifiable people or a single election.

[^c7-economic-voting]: V. O. Key Jr., *The Responsible Electorate: Rationality in Presidential Voting, 1936–1960* (Cambridge, MA: Belknap Press of Harvard University Press, 1966); Morris P. Fiorina, *Retrospective Voting in American National Elections* (New Haven: Yale University Press, 1981).

[^c7-bls-shed]: U.S. Bureau of Labor Statistics, Consumer Price Index and Employment Situation releases, 2020–2024; Board of Governors of the Federal Reserve System, *Report on the Economic Well-Being of U.S. Households*, 2022–2024.
