...
spine.png        # 56×2775   @ 300 ppi — center-cropped from 74×2775 master (75 cream pages)
...
`template_page_count` / `template-meta.yml` are locked to the measured interior (**75**). Regenerate `spine.png` + geometry if the interior length changes. Back barcode clear area is ~2.58″ × 1.52″ (meets ≥1.75″ × 1.0″). See `docs/publishing/ingramspark-raster-wrap.md`.
