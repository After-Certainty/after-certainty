...
corrections are delayed because the temporary command protocol blocks local
overrides.
...
post-spike review window.

Ten days later, district override authority is restored, challenge calls
reopen, and two corridors are rerouted from local signal. Officials still cite
the emergency protocol as useful, with a posted sunset and review date.
:::
