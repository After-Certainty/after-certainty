...
::: {custom-style="Vignette Block"}
A youth soccer club is one week out from hosting a regional tournament. A volunteer who helps maintain the fields notices a goal on the secondary pitch is still not anchored to code. She raises it at the coaches’ meeting. The club president answers: they cannot slip the bracket; hotels are full; sponsor banners are already staged for the main pitch photoshoot. “Note it for after regionals,” he says. “We need both fields live for scheduling.” That first answer is where the club learns what will count for everything that follows. The trade is explicit: visitors and kids on the secondary pitch carry the exposure so the hosted weekend and the center’s story stay intact.
