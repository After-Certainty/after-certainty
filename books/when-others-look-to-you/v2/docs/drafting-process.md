...
**Manuscript root:** `books/when-others-look-to-you/v2/`
...
- **Word export:**  
  `make export-docx DIR=books/when-others-look-to-you/v2`  
  Requires `v2/docs/reference.docx` (copy or symlink from `v1/docs/reference.docx` until v2 has its own template).

- **Kindle EPUB:**  
  `make export-kindle-epub DIR=books/when-others-look-to-you/v2`
