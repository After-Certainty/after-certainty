...
- Introduction — The Question That Changes Nothing
- Part I — Where Interpretation Ends
  - Ch 1 — The Door That Opens Only Inward (Joseph Smith)
  - Ch 2 — Everyone Already Knows (Jim Jones)
- Part II — What Replaces Interpretation
  - Ch 3 — The Argument That Sorts the Room (Donald Trump)
  - Ch 4 — The Name That Survives Every Platform (Juan Perón; Hugo Chávez echo)
  - Ch 5 — The Applause No One Wants to End (Joseph Stalin; Adolf Hitler contrast)
  - Ch 6 — The Story That Explains Every Objection (David Koresh)
- Part III — When Correction Cannot Reach
  - Ch 7 — The Question That Becomes Disloyalty (Elizabeth Holmes + Adam Neumann)
  - Ch 8 — The Criticism That Cannot Correct (Mao Zedong)
...
1. Ch 2 Jones (core distinction)
2. Ch 3 Trump → Ch 5 Stalin → Ch 6 Koresh → Ch 8 Mao
3. Ch 1 Smith → Ch 4 Perón → Ch 7 Holmes/Neumann
4. Ch 9 Khmer Rouge
...
Ch 1 (Smith / door) rewritten essayistically. Remaining: complete other chapter rewrites; slim glossary; rebuild bibliography; author gate on Trump tone, Smith boundary, Ch 9 ethics, mechanism uniqueness.
