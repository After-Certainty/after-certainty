# When the Key Changes Hands — Drafting Process

## Purpose

Workflow for building and revising **When the Key Changes Hands** in a structured, review-driven way.
...
- `upcoming/when-the-key-changes-hands-structure`
- `upcoming/when-the-key-changes-hands-draft`
- `upcoming/when-the-key-changes-hands-editorial`
