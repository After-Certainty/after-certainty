...
HealthCare.gov tells people who disagree with an insurance company's final internal appeal decision that they may be able to ask for an external review: an independent review by someone outside the health plan. But as of July 1, 2026, the site stated that the HHS-administered Federal External Review Process was temporarily unavailable for residents of Alabama, Florida, Georgia, Texas, Wisconsin, and U.S. territories other than Puerto Rico whose plans use that process. Plans that do not use the HHS-administered process were directed to follow the notice from the plan or issuer.[^c3-healthcaregov]
