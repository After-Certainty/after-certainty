# Why Collaboration Is So Hard — agent specs (essay edition archive)

> **Archived.** These agents applied to the May 2026 14-chapter essay edition. The live recognition rewrite uses house recognition skills—see [`../../../agents/README.md`](../../../agents/README.md). Paths below still describe the essay tree under this `source-edition/` folder.

**Eight revision agents** (numbered **01–08**) for chapter-by-chapter and manuscript-gate work on the **essay** manuscript. Copy a spec into a Cursor agent prompt with the **target unit file** and linked docs, or use as a human checklist.
...
**House rules for the essay edition (historical):**  
[`../../../../book-rules.md`](../../../../book-rules.md) · essay reading order [`../../index.md`](../../index.md)
