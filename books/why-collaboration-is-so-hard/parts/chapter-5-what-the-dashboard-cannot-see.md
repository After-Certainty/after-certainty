...
The alternative to bad measurement is not romantic trust. Trust without visibility can become permission. Visibility without trust can become surveillance.[^c5-march-simon] Collaboration must live between them. That middle is uncomfortable because it does not offer a single rule. Sometimes the dashboard is revealing what staff would rather not see. Sometimes staff are revealing what the dashboard cannot see. Sometimes leaders ask for clarity because a real failure has been hidden behind complexity. Sometimes they ask for clarity because they cannot tolerate a reality that remains uncertain. The form of the request may sound the same.
