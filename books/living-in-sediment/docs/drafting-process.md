# Living in Sediment — Drafting Process

## Purpose

Workflow for building and revising **Living in Sediment** in a structured, review-driven way.

## Key references

- `docs/book-rules.md` — house rules (wins on conflict)
- `docs/status.md` — unit progress and next actions
- `docs/chapter-outline.md` — full structural skeleton
...
- `upcoming/living-in-sediment-structure`
- `upcoming/living-in-sediment-draft`
- `upcoming/living-in-sediment-editorial`
...
- **Essayistic form:** chapters scale to the thought—no padding toward a word band. Use Chapter 8 as the voice reference.
...
- Part II+: confirm tone shift (legitimacy, power) lands without defensiveness spike
...
- Move or copy into `books/living-in-sediment/`
- Enable exports in `book.yml`
- Add cover and OG assets
- Update [upcoming/docs/portfolio-status.md](../../docs/portfolio-status.md)
- Update [docs/series-guide.md](../../docs/series-guide.md)
