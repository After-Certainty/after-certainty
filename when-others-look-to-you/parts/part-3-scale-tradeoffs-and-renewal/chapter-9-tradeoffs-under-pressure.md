...
- **Vital:** reach and adjustment both hold under load.
- **Nimble:** adjustment holds locally, but broader coordination strains.
- **Brittle:** reach still holds, but revision narrows.
- **Stagnant:** neither reach nor revision holds with reliability.
...
The tradeoff was initially practical. The drift came later, when temporary
...
time, restraint often preserves adjustability and limits downstream
harm.[^c9-escalation]
