...
For global tone and universality rules, see `book-rules.md`. For pattern blocks only, see `pattern-integration-guide.md`.
...
- Opening: tie renewal questions to **Chapter 2** in plain words (change direction under pressure; common effort without getting stuck).
