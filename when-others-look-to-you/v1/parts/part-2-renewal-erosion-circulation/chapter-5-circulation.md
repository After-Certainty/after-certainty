...
For now, the point is that **circulation** is about more than whether the work gets done. It is about what the group comes to believe about who may lead. Those beliefs harden long before anyone reads an org chart.
...
They learn leadership from inside the role—not only from watching someone else hold it. What spreads is the capacity for **correction**, adaptation, and shared authority. When formal leadership turns over, the new person inherits the position *and* inherits a culture where being challenged in the chair is still normal.

**Renewal** at the center and **circulation** through the bench reinforce each other. The center stays revisable because the bench has practiced holding it. The bench stays trustworthy because the center does not treat every temporary lead as a threat.

### **Circulation in the Decaying Group**

**Circulation** does not disappear under **decay**. It tightens.

Influence still moves, but through channels the center already trusts. The people invited to "step up" are the ones who have shown they will not disturb the pattern. Temporary authority becomes a reward for alignment, not a test of judgment.
...
What travels is not flexibility to lead but a template for how leadership is performed here. Underneath that sits a practiced incapacity at the edges. People learn the wrong lesson and never rehearse holding the center.

**Erosion** can persist without a single villain. It only needs each cohort to learn, before they ever hold the title, whether stepping into the gap is safe.
