...
The next chapter defines the two capacities—**scalability** and **adaptability**—and
how their combinations sort into the **vibrant group** and the **decaying group**,
with the structural grid. After that, the pattern chapters take **renewal** and
**erosion** each in turn.
