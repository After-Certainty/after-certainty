...
learning, and future capacity.[^c6-performance-paradox]
...
Observers infer sound leadership. Sometimes they are right. Sometimes they are
not.
...
**Erosion** tends to borrow against the future.[^c6-deferred-costs]
...
**Regenerative** and **adaptive** together make up the **vibrant group**.
**Entrenched** and **stalled** together make up the **decaying group**.
...
arrive later, softer, or not at all.[^c6-escalation]
...
This is one of leadership’s recurring traps: success narrows the very channels
needed to prevent future failure. The same season of wins also trains what the
next cohort will treat as normal leadership here—**Leadership Reproduces
Itself**.
...
punishment.[^c6-voice] While that remains true, **Dissent is Welcomed** still
holds.

**Correction** is a practical check. It shows where the group sits on the
map of **renewal** and **erosion**. It shows whether conditions still read as
the **vibrant group** or have drifted toward the **decaying group**.

Without **correction**, authority still exists, but learning slows. Groups
...
- Shared **circulation** (guest leadership): influence moves both ways.
  ...
  then return to their usual role.[^c6-guest-leadership]
...
Retreat shows up as silence or workaround behavior. Offers to step in get
shorter and more guarded. Influence routes through formal channels only. Help
stays inside official boxes and rarely moves beyond them. Punishment can mean
being treated as stepping out of line, embarrassing the role-holder, or making
defense too costly.

That retreat is **Leadership Reproduces Itself** in practice. What gets
rewarded or punished locally becomes the template people imitate when they step
into leadership next.
...
reliable than groups that avoid visible failure at all costs.[^c6-learning]

The issue is not whether failure occurs. The issue is whether learning
follows. When **Feedback Drives Change** still holds, new information and visible
risk can still steer direction. Commitment stays open to revision when reality
pushes back.
...
:::
[^c6-deferred-costs]: On short-term smoothing, defensive routines, and paying
  later in larger forms, see Chris Argyris, *Overcoming Organizational Defenses*
  (Boston: Allyn and Bacon, 1990).
[^c6-performance-paradox]: Chris Argyris and Donald A. Schon, *Organizational Learning II: Theory, Method, and Practice* (Reading, MA: Addison-Wesley, 1996).
[^c6-escalation]: Barry M. Staw, "Knee-Deep in the Big Muddy: A Study of Escalating Commitment to a Chosen Course of Action," *Organizational Behavior and Human Performance* 16, no. 1 (1976): 27–44.
[^c6-learning]: Amy C. Edmondson, *The Fearless Organization: Creating Psychological Safety in the Workplace for Learning, Innovation, and Growth* (Hoboken, NJ: Wiley, 2018).
[^c6-voice]: Albert O. Hirschman, *Exit, Voice, and Loyalty* (Cambridge, MA: Harvard University Press, 1970).
[^c6-guest-leadership]: Alistair Cockburn, "How to Step Up Stepping Up: Promoting Guest Leadership for Successful Collaboration," *Cutter IT Journal*, https://www.cutter.com/article/how-step-stepping-promoting-guest-leadership-successful-collaboration-494516.
