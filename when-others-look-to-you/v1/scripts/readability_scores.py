...
ORDERED: list[tuple[str, str, str]] = [
    ...
    ("Part I", "Bridge", "parts/part-1-how-influence-forms/bridge.md"),
    (
        "Part I",
        "Ch 1 — The Weight of Being Looked To",
        "parts/part-1-how-influence-forms/chapter-1-the-weight-of-being-looked-to.md",
    ),
    (
        "Part II",
        "Bridge — From Formation to Movement",
        "parts/part-2-renewal-erosion-circulation/bridge-from-formation-to-movement.md",
    ),
    (
        "Part II",
        "Ch 2 — Renewal",
    ...
    (
        ...
        "parts/part-3-harm-effectiveness-legitimacy/bridge-from-movement-to-lenses.md",
    ),
    (
        "Part III",
    ...
    (
        "Part IV",
        "Bridge — From Structure to Scale and Judgment",
        "parts/part-4-scale-pressure-misjudgment/bridge-from-structure-to-scale-and-judgment.md",
    ),
    (
        "Part IV",
    ...
    (
        ...
        "parts/part-5-closing/bridge-from-misjudgment-to-what-remains.md",
    ),
    (
        "Part V",
