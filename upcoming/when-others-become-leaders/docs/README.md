# When Others Become Leaders — Planning Docs

Central navigation for planning documents for *When Others Become Leaders: What Enduring Influence Leaves Behind*.

## Start here

- [Book overview](book-overview.md) — title, core idea, central question, thesis, positioning, status
- [Outline](outline.md) — introduction, three-part arc, nine chapters, epilogue
- [Voice guide](voice-guide.md) — prose method, paragraph rhythm, anti-pattern checks
- [Chapter architecture](chapter-architecture.md) — reusable chapter template and movement options
...
- Use [book-overview.md](book-overview.md) for the thesis-level description.
- Use [outline.md](outline.md) for chapter ordering and per-chapter planning fields.
- Use [voice-guide.md](voice-guide.md) for prose standards and weak-vs-better opening examples.
- Use [research-plan.md](research-plan.md) for source strategy and verification rules.
- Use [open-questions.md](open-questions.md) for unresolved decisions.
