...
|------|-------|------------------|-------------|--------|
| [The Game We Think We Saw](../the-game-we-think-we-saw/) | Phase 0 | Architecture and research scaffold; outline + briefs; **no chapter prose** | Author architectural review; evidence dossiers for Ch 4 / Ch 7 | [status](../the-game-we-think-we-saw/docs/status.md) |
