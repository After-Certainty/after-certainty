...
|------|-------|------------------|-------------|--------|
| [When Others Become Leaders](../when-others-become-leaders/) | Phase 2 prep | First draft ~50k; Phase 1 research complete | Unit editorial passes (manuscript order) | [status](../when-others-become-leaders/docs/status.md) |
