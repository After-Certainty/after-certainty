...
|------|-------|------------------|-------------|--------|
| [Learning to See](../learning-to-see/) | Phase 0 | Full manuscript outline; reserved drafts external (Intro, Ch 1–2) | Import drafts; author outline review; consultation before Part II | [status](../learning-to-see/docs/status.md) |
