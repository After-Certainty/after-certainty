...
|------|-------|------------------|-------------|--------|
| [The Game We Think We Saw](../the-game-we-think-we-saw/) | Phase 1 | Intro drafted (citation + reflow); chapters still stubs | Paste next unit (likely Ch 1); Ch 4 / Ch 7 dossiers before those units | [status](../the-game-we-think-we-saw/docs/status.md) |
