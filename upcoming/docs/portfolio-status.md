...
|------|-------|------------------|-------------|--------|
| [The Case That Does Not Fit](../the-case-that-does-not-fit/) | Source-verify + consolidate (~30.1k; DOCX on) | Footnotes verified; scenes integrated; Ch5/8/11 tightened | Author DOCX review; recheck live 2026 anchors | [status](../the-case-that-does-not-fit/docs/status.md) |
...
*Active under `upcoming/`:* **The Case That Does Not Fit**. Companion **No Time to Think** was promoted to [`books/no-time-to-think/`](../../books/no-time-to-think/). **The World We Make Together** was promoted to [`books/the-world-we-make-together/`](../../books/the-world-we-make-together/).
...
| [The Game We Think We Saw](../../books/the-game-we-think-we-saw/) | What a decisive sports result leaves unsettled—cause, legitimacy, cost, meaning (practice/mid) |
| [The World We Make Together](../../books/the-world-we-make-together/) | Collective causation and shared power under unequal leverage (~49k) |
| [No Time to Think](../../books/no-time-to-think/) | Capacity for judgment under acceleration—time, attention, stop authority (~30k) |
...
Promoted to `books/` (essay editions):

1. [after-certainty](../../books/after-certainty/)
2. [before-certainty-arrives](../../books/before-certainty-arrives/)
3. [when-accountability-no-longer-expires](../../books/when-accountability-no-longer-expires/)
