...
|------|-------|------------------|-------------|--------|
| [No Time to Think](../no-time-to-think/) | Phase 1 complete (first prose draft) | Full manuscript ~10.8k; DOCX enabled for review | Author whole-book review; deepen Part II source dossiers | [status](../no-time-to-think/docs/status.md) |
