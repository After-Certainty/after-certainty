...
|------|-------|------------------|-------------|--------|
| [No Time to Think](../no-time-to-think/) | Phase 1 — Outline to prose | Introduction drafted (~850 words); other units still stubs | Author review of intro; then Ch 1 Dashboard | [status](../no-time-to-think/docs/status.md) |
