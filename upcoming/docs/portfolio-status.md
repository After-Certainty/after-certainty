...
|------|-------|------------------|-------------|--------|
| [When Others Become Leaders](../when-others-become-leaders/) | Phase 1 | First draft ~50k; length locked; cover + `book.yml` in `upcoming/` | Source packets + citation verification | [status](../when-others-become-leaders/docs/status.md) |
