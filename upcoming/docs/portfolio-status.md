...
|------|-------|------------------|-------------|--------|
| [Learning to See](../learning-to-see/) | Phase 2 | Full manuscript; all unit passes complete | Author full-manuscript review; Phase 3 coherence gates | [status](../learning-to-see/docs/status.md) |
