...
|------|-------|------------------|-------------|--------|
| [When Others Become Leaders](../when-others-become-leaders/) | Phase 4 prep | Phase 3 complete (~51k); manuscript-wide editorial next | Global echo + copy edit | [status](../when-others-become-leaders/docs/status.md) |
