...
|------|-------|------------------|-------------|--------|
| [The Case That Does Not Fit](../the-case-that-does-not-fit/) | Developmental deepen (~31k; DOCX on) | Part I scenes; Lumley / 504 sit-in / Overton Park; Ch 11 reorganized | Author DOCX review; primary-source deepening | [status](../the-case-that-does-not-fit/docs/status.md) |
