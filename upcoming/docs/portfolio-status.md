...
|------|-------|------------------|-------------|--------|
| [The World We Make Together](../the-world-we-make-together/) | Phase 1 | Through Ch 9 (Scale); cover/OG | Editorial review; citation pass; The Window | [status](../the-world-we-make-together/docs/status.md) |
