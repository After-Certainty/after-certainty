...
|------|-------|------------------|-------------|--------|
| [The Game We Think We Saw](../the-game-we-think-we-saw/) | Phase 1 | Intro + Ch 1–6 drafted (citation + reflow); Ch 7 stub | Ch 7 Kaepernick dossier before that unit; then conclusion | [status](../the-game-we-think-we-saw/docs/status.md) |
