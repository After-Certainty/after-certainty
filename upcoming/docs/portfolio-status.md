...
|------|-------|------------------|-------------|--------|
| [No Time to Think](../no-time-to-think/) | Publication-prep (~30k) | Front matter, citation hygiene, redundancy/rhetoric pass; DOCX on | Author whole-book review; reverify 2026 anchors | [status](../no-time-to-think/docs/status.md) |
