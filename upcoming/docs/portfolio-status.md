...
|------|-------|------------------|-------------|--------|
| [When Others Become Leaders](../when-others-become-leaders/) | Phase 2 | First draft ~50k; Phase 1 complete; unit editorial passes underway | Continue Ch. 1 — The Table | [status](../when-others-become-leaders/docs/status.md) |
