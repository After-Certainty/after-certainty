...
|------|-------|------------------|-------------|--------|
| [The Game We Think We Saw](../the-game-we-think-we-saw/) | Phase 1 | Intro + Ch 1–3 drafted (citation + reflow); Ch 4–7 stubs | Next unit; Ch 4 / Ch 7 dossiers before those units | [status](../the-game-we-think-we-saw/docs/status.md) |
