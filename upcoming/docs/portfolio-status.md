...
|------|-------|------------------|-------------|--------|
| [The Game We Think We Saw](../the-game-we-think-we-saw/) | Phase 1 | Intro + Ch 1–7 drafted (citation + reflow); conclusion stub | Conclusion + part bridges; then length/promotion decisions | [status](../the-game-we-think-we-saw/docs/status.md) |
