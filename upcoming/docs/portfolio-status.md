...
|------|-------|------------------|-------------|--------|
| [Learning to See](../learning-to-see/) | Phase 3 | Full manuscript; part coherence gates passed | Author full-manuscript review; Phase 4 editorial | [status](../learning-to-see/docs/status.md) |
