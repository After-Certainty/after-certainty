...
|------|-------|------------------|-------------|--------|
| [The Case That Does Not Fit](../the-case-that-does-not-fit/) | Final proof / prod-prep (~30.2k; DOCX on) | Footnotes merged; keywords fixed; cover alt; proof PDF | Cover strapline vs subtitle; print/ebook workflows | [status](../the-case-that-does-not-fit/docs/status.md) |
