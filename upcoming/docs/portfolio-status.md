...
|------|-------|------------------|-------------|--------|
| [No Time to Think](../no-time-to-think/) | Production pass (~29.5k) | Footnotes consolidated; Ch10 transitions; stop-work reframed; DOCX audited | Author whole-book review; reverify 2026 anchors | [status](../no-time-to-think/docs/status.md) |
