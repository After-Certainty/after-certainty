...
|------|-------|------------------|-------------|--------|
| [When Others Become Leaders](../when-others-become-leaders/) | Author gate | Phase 4 complete (~51k); read-through then promote | Author sign-off → Phase 5 | [status](../when-others-become-leaders/docs/status.md) |
