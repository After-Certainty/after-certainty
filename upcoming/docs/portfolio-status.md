...
|------|-------|------------------|-------------|--------|
| [The World We Make Together](../the-world-we-make-together/) | Phase 1 | Through Ch 10 (Window); cover/OG | Editorial review; citation pass; The Table | [status](../the-world-we-make-together/docs/status.md) |
