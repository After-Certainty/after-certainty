...
|------|-------|------------------|-------------|--------|
| [The World We Make Together](../the-world-we-make-together/) | Phase 1 | Intro + Ch 1 (Photograph) drafted; cover/OG; architecture in outline | Editorial review; citation pass Ch 1; then The Door | [status](../the-world-we-make-together/docs/status.md) |
