...
|------|-------|------------------|-------------|--------|
| [No Time to Think](../no-time-to-think/) | Developmental pass (~31k) | Deepen-the-world pass: lived scenes + strengthened history; DOCX on | Author whole-book review | [status](../no-time-to-think/docs/status.md) |
