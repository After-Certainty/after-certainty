...
|------|-------|------------------|-------------|--------|
| [The Case That Does Not Fit](../the-case-that-does-not-fit/) | Final continuity pass (~30.2k; DOCX on) | New subtitle; verification seams to notes; volatile recheck | Author DOCX review; cover strapline vs subtitle | [status](../the-case-that-does-not-fit/docs/status.md) |
