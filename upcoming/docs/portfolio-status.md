...
|------|-------|------------------|-------------|--------|
| [The Game We Think We Saw](../the-game-we-think-we-saw/) | Phase 1 | Draft branch open; awaiting author unit drafts (citation + reflow on intake) | Paste first draft unit; Ch 4 / Ch 7 dossiers before those units | [status](../the-game-we-think-we-saw/docs/status.md) |
