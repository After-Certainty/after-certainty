...
|------|-------|------------------|-------------|--------|
| [The Game We Think We Saw](../the-game-we-think-we-saw/) | Phase 1 | Intro + Ch 1–5 drafted (citation + reflow); Ch 6–7 stubs | Next unit; Ch 7 Kaepernick dossier before that unit | [status](../the-game-we-think-we-saw/docs/status.md) |
