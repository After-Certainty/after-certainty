...
|------|-------|------------------|-------------|--------|
| [The World We Make Together](../the-world-we-make-together/) | Phase 1 | Full draft + citation pass; DOCX export enabled | Editorial review | [status](../the-world-we-make-together/docs/status.md) |
