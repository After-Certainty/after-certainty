...
|------|-------|------------------|-------------|--------|
| [The Game We Think We Saw](../the-game-we-think-we-saw/) | Phase 1 | Full spine + bridges + cover/OG; **docx enabled** | Review DOCX; length band; title/copyright/series placeholders | [status](../the-game-we-think-we-saw/docs/status.md) |
