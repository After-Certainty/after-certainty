...
|------|-------|------------------|-------------|--------|
| [The World We Make Together](../the-world-we-make-together/) | Phase 1 | Scaffold + Introduction — The Switch drafted (~2.6k); full architecture in outline | Editorial review of intro; then Photograph | [status](../the-world-we-make-together/docs/status.md) |
