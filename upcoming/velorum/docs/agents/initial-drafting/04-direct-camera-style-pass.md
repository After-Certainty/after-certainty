...
- **Strip condensed metaphors** in narration (*like weather*, *catch the almost*, *sat like*, thesis-shaped interior)
- **Sayable dialogue** under stress — stakes before ornament; **profanity preserved** per voice-spec
- **Observable character intros** — build, gear, action; not literary motion summaries
- **Bond beats** — name whose body feels what; plain physics first

**DO:**
- Read **house rules** first: **[voice-spec.md](../../voice-spec.md)** → **Direct camera style pass**, **Plain dialogue**, **Camera-observable narration**, **Voice guardrails**
- Work from the **existing chapter**; **do not** change plot, POV assignment, or who speaks
- **Search and fix** high-yield patterns: ` like ` / ` as if ` / ` seemed to ` / ` felt like ` in **narration** (keep in **dialogue** when natural)
...
**STYLE:**
- Contemporary American mouths on a mythical frame  
- Vivid because **concrete**, not because ornate  
- Sarah Beth Durst–like **clarity** without lit-mag distance

**OUTPUT:**
- **Full revised chapter** (markdown) with same events and POV  
- Optional: short note listing **categories** trimmed (simile stacks, oracle lines, thesis dialogue) — not required every run
