...
- **Paragraph merge:** join **single-sentence paragraphs** into **multi-sentence** blocks where the blank line only added staccato—same rules as **[03-flow-clarity-editor.md](./03-flow-clarity-editor.md)** (*paragraph merge pass*); keep **speaker clarity** when dialogue shares a paragraph
