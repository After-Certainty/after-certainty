...
- **Add** new figurative or “lyrical” flourishes when smoothing cadence—prefer **plain connective** words and **concrete** anchors (**[agents README](./README.md#concrete-description-default) → Concrete description**)
