...
[^c2-gao-notes]: U.S. Government Accountability Office, "Science & Tech Spotlight: AI for Medical Notes and Coding," GAO-26-109116, July 16, 2026, https://www.gao.gov/products/gao-26-109116. Finds that AI tools may reduce documentation burden while remaining difficult to verify for accuracy and completeness, with uncertain effects on spending and oversight. The fifty-seven-hour average workweek and roughly seven administrative hours per week are drawn from the assessment's characterization of clinician time burden.
