...
[^c1-he-throughput]: Hao He et al., "AI Writes Faster Than Humans Can Review: A Longitudinal Study of an Enterprise 2x Mandate," arXiv:2607.01904, July 2, 2026, https://arxiv.org/abs/2607.01904. Study of 802 developers and 196,212 pull requests in which per-capita throughput rose substantially while per-reviewer load roughly doubled and automated review overtook human review; merge and revert rates remained stable during the study window. Broader AI-assistant productivity findings vary by task type, team, and baseline.
