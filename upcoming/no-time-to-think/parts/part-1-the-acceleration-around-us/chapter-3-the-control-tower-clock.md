...
The FAA's 2026 Air Traffic Controller Workforce Plan described longstanding controller shortages and proposed aggressive hiring, modern scheduling tools, new staffing models, and modernization of the National Airspace System.[^c3-faa-workforce] It also acknowledged the need to reduce excessive overtime that can lead to fatigue and burnout while improving operational efficiency. Hiring more controllers and redesigning schedules are necessary responses to shortage. A system that is understaffed is a system that asks its controllers to carry more than the work is designed to hold.
...
[^c3-faa-workforce]: Federal Aviation Administration, "FAA Releases Bold, New Air Traffic Controller Hiring Plan," May 15, 2026, https://www.faa.gov/newsroom/faa-releases-bold-new-air-traffic-controller-hiring-plan; see also the FAA's 2026 Air Traffic Controller Workforce Plan. The release states that modern staffing models and scheduling tools aim to improve operational efficiency and reduce excessive overtime that can lead to fatigue and burnout. Specific numbers regarding current staffing levels and hiring targets appear in the workforce plan document; verify against the published plan before final citation lock, as workforce plans are periodically revised. The core tension between headcount shortage and the attentional demands of the work is documented in the FAA's own characterization of the problem.
