# No Time to Think — Drafting Process

## Purpose

Workflow for building and revising **No Time to Think** in a structured, review-driven way.
...
- `upcoming/no-time-to-think-structure`
- `upcoming/no-time-to-think-draft`
- `upcoming/no-time-to-think-editorial`
...
- Reverify 2026 current-event anchors before drafting Part I prose.

### Phase 2 — Unit passes (per chapter, bridge, or front/back matter section)

After drafting or revising one unit:

1. **Rules check** — alignment with `docs/book-rules.md`, core invariant, shifted-bottleneck test.
2. **Echo pass** — flag repeated phrasing, claims, and examples against prior units and companion *The Case That Does Not Fit*.
...
- Move or copy into `books/no-time-to-think/`
