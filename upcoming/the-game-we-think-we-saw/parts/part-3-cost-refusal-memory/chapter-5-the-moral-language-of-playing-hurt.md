...
Research involving collegiate athletes has found that pressure to avoid disclosing a concussion can come from coaches, teammates, parents, and fans, while NCAA educational material has explicitly warned that athletes may hide symptoms because they fear losing playing time.[^c5-reporting-pressure]
...
This is what people who want to win are willing to endure.
...
Good enough to tolerate the pain.
Good enough to help for a few minutes.
Good enough to avoid obvious injury.
Good enough because the game matters.
Good enough because saying otherwise feels impossible.
...
[^c5-concussion-symptoms]: CDC HEADS UP lists common concussion symptoms including headache or pressure in the head, nausea or vomiting, balance problems or dizziness, double or blurry vision, sensitivity to light or noise, feeling sluggish/hazy/foggy, confusion, concentration or memory problems, and not “feeling right”; irritability and slowed thinking appear among recognized symptom clusters in clinical and educational materials. CDC, “Symptoms of Concussion,” https://www.cdc.gov/heads-up/signs-symptoms/; NCAA Concussion Fact Sheet for Coaches (symptoms reported by student-athlete), http://fs.ncaa.org/Docs/health_safety/ConFactSheetcoaches.pdf.

[^c5-reporting-pressure]: Approximately one-quarter of collegiate athletes in surveyed research have reported pressure from at least one source—coaches, parents, teammates, and/or fans—to avoid disclosing a concussion. See e.g. discussion in Moore et al., “Factors and expectations influencing concussion disclosure within NCAA Division I athletes,” *Journal of Athletic Training* (2023), https://pmc.ncbi.nlm.nih.gov/articles/PMC10199141/, citing prior prevalence findings. NCAA Concussion Fact Sheet for Coaches states: “Athletes may not report their symptoms for fear of losing playing time.” http://fs.ncaa.org/Docs/health_safety/ConFactSheetcoaches.pdf. See also Weber Rawlins et al., “Concussion Symptom Underreporting Among Incoming NCAA Division I College Athletes,” *Clinical Journal of Sport Medicine* (2019), https://pmc.ncbi.nlm.nih.gov/articles/PMC6488438/ (fear of losing playing time among leading endorsed reasons for non-disclosure).

[^c5-nfl-protocol]: NFL Head, Neck and Spine Committee—independent and NFL-affiliated physicians and scientists, including advisers for the NFL Players Association—developed the NFL Game Day Concussion Diagnosis and Management Protocol in 2011; the league states the protocol is reviewed each year. NFL, “Concussion Protocol & Return-to-Participation Protocol: Overview,” https://www.nfl.com/playerhealthandsafety/resources/fact-sheets/concussion-protocol-return-to-participation-protocol.

[^c5-cdc-rts]: CDC HEADS UP six-step return-to-play progression (based on International Concussion in Sport guidelines): (1) back to regular activities; (2) light aerobic activity; (3) moderate activity; (4) heavy non-contact activity; (5) practice / full contact; (6) competition. Progression under healthcare-provider supervision; return of symptoms requires stopping and, after rest, resuming at an earlier step. CDC, “Returning to Sports,” https://www.cdc.gov/heads-up/guidelines/returning-to-sports.html.

[^c5-pitch-smart]: Pitch Smart, a joint MLB / USA Baseball initiative, provides age-based daily pitch maximums and required rest periods; MLB states research has shown pitch counts are “the most accurate and effective means” of limiting the likelihood of pitching with fatigue. Guidelines also recommend multi-month time away from competitive pitching / overhead throwing and advise avoiding playing for multiple teams at the same time and year-round pitching workloads. MLB Pitch Smart pitching guidelines, https://www.mlb.com/pitch-smart/pitching-guidelines; age-band pages (e.g. ages 9–12, 15–18).

[^c5-nba-ppp]: NBA Board of Governors approved the Player Participation Policy for the 2023–24 season (enhancing/replacing the prior Player Resting Policy). Focus on “star” players (All-NBA or All-Star in any of the prior three seasons): among other requirements, manage roster so no more than one star is unavailable for the same game; ensure star availability for national television and In-Season Tournament games; exceptions for injuries, personal reasons, and pre-approved back-to-back restrictions based on age, career workload, or serious injury history. NBA Communications, “NBA Board of Governors approves new Player Participation Policy,” https://pr.nba.com/nba-board-of-governors-approves-player-participation-policy/.

[^c5-nba-load-study]: League-circulated research (IQVIA Injury Surveillance & Analytics with NBA medical leadership; multi-season electronic medical record data) reported no lower injury rate associated with games missed for rest / load management in the data examined. Dr. Christina Mack: researchers “did not see a lower injury rate when players rested.” Contributors emphasized other injury factors (prior injury, surgery, age) and that the report does not insist load management never works; Dr. John DiFiori: “There needs to be a balance between rest and recovery.” NBA.com, “NBA sends teams the results found in load management study,” https://www.nba.com/news/nba-sends-data-load-management-study; related reporting in The Athletic, Jan. 12, 2024.
