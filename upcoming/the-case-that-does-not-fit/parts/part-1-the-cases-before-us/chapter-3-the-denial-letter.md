...
Consider what a patient may need to appeal a denial. Time to read the letter. Enough health to make phone calls. Enough language access to understand the terms. A clinician willing and able to write supporting documentation. Medical records. Familiarity with deadlines. Persistence through transfers, portals, faxes, hold music, form letters, and requests for information already supplied. Sometimes a caregiver. Sometimes an attorney. Sometimes money to absorb delay. Sometimes the emotional capacity to keep arguing while sick.

The institution may describe this as process. The patient may experience it as a second illness.

The gap between those descriptions is where formal appeal becomes unreachable appeal.

---

Automation can widen the gap if review capacity does not widen with it.

The point does not require treating AI-assisted prior authorization as inherently illegitimate. Automated tools can identify missing documentation, detect conflicts, apply criteria consistently, and reduce delay for straightforward approvals. They can help prevent one reviewer from treating similar requests differently for reasons no one can justify. In a system with enormous volume, some structured assistance may be necessary just to keep decisions from becoming backlog by another name.

The risk arises when the first decision becomes faster than the institution's capacity to reconsider it.

A model, rule engine, or automated workflow can sort cases quickly. It can apply criteria without fatigue. It can generate a denial reason in polished language. It can route the patient to the next step. But if each denial requires the patient and clinician to assemble individualized proof that the category was wrong, then speed has not eliminated judgment. It has relocated it. The burden moves to the person least equipped to carry it: the patient whose care is delayed and the clinician whose time is already overfilled.

This is familiar from other systems. A form can be easy to submit and hard to correct. A portal can be efficient for ordinary cases and punishing for exceptions. A denial can be produced in seconds and take weeks to unwind. The first decision gains the authority of administrative fluency; the appeal absorbs the messy facts the first decision did not understand.

If the appeal pathway is strong, that may be acceptable. If it is weak, unavailable, or practically inaccessible, the system has built speed into refusal and friction into correction.
...
Rules discipline this. They say that decisions should not depend entirely on volume, charm, anger, institutional sophistication, or the luck of reaching a generous reviewer. They provide a common standard. They make denial possible in cases where denial is justified.

But every medical-necessity rule is a compression. It describes a general relationship between diagnosis, treatment, evidence, cost, and expected benefit. The patient before the rule may have failed previous therapy, developed complications, responded unusually, lacked access to the cheaper alternative, or faced timing that changes the consequence of delay. The file may be missing the very fact that would change the decision. Or the fact may be present but coded in a way the reviewer did not recognize.

The appeal is supposed to be where that difference enters.

This means the burden of appeal is not an incidental inconvenience. It is part of the institution's moral architecture. Who must prove that the first decision was wrong? How much expertise must they have? How much delay must they survive? Does the reviewer encounter the patient's actual circumstances, or only another layer of codes? Is there an independent person with authority to say the rule misread this case?

If the answers are weak, the denial letter's appeal paragraph becomes an alibi.
