...
The National Archives recounts that the West Coast was divided into military zones, that curfews and exclusion measures followed, and that forced evacuation and detention of Japanese American West Coast residents proceeded on short notice.[^c9-archives-lesson] The notices turned families into cases of a category. People reading them encountered the general rule as a private rupture. The state did not need to know the texture of their lives in order to reorder them.
