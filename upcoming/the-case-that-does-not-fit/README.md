...
Rules make shared life possible. But every rule is a compression: it identifies the differences that count and ignores the rest. *The Case That Does Not Fit* examines what happens when the ignored detail becomes the morally decisive one.
