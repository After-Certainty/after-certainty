...
**Phase 2 — Part I complete (depth + voice pass)**
...
| Title Page | draft | |
| Copyright | draft | |
| Core Reframe | draft | Pass 6 expansion (~30% prose) |
| What This Book Is | draft | Expanded May 2026 |
| Organizing Question | draft | Expanded May 2026 |
| Ch 1 — What No One Owns Alone | draft | Pass 6: new §5, flagship case removed |
| Ch 2 — Why Shared Work Feels Unstable | draft | Pass 6: new §5 pace/tempo |
| Ch 3 — Alignment Without Full Understanding | draft | Pass 6: new §6 translation; COVID opener removed |
| Ch 4 — Contribution Moves Unevenly | draft | Pass 6: new §6 steady signal; opener replaced |
...
2. Phase 2 unit passes on Parts II–IV: echo, editorial, citation at pivots.
3. Chapter depth expansion beyond Part I toward book-rules target band.

## Open decisions / known issues

- Ch 14 and back-matter conclusion both address "why the effort still matters"; keep distinct roles (chapter = affirmative case, conclusion = arc + invariant, no method sermon).
- Footnote on Ch 4 emotional labor still marked verify source.

## Rough scale

- ~10,800 words (May 2026 Pass 6; up from ~9,300)
