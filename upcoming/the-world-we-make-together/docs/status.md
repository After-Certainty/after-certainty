# The World We Make Together — Drafting Status
...
`cursor/the-world-we-make-together-intro-3055`
...
- [`outline.md`](outline.md) — full architecture (writing plan)
...
- Minimal `book.yml` present for cover/OG fields (upcoming schema; DOCX export enabled with interior_finish).
...
- Introduction words: ~2,800
- Chapter 1 words: ~3,400
- Chapter 2 words: ~3,700
