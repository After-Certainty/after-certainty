...
What she could offer was something more demanding than neutrality: a recommendation she was willing to own.
...
Judgment is not the absence of bias.

It is not what remains after you have scrubbed preference, history, and training away. That scrubbing is itself a myth—often a polite one. Committees call it **objectivity** when they mean **procedure**. Individuals call it **being rational** when they mean **being sure**. Institutions call it **data-driven** when they mean **what the dashboard can carry**.
...
Adaptive mechanisms do not excuse harm. A narrowed attention budget can still miss the child in the waiting room. A trusted expert can still be wrong. A map can still hide the pump. Judgment is where the book stops describing architecture and starts describing **accountability**—not because bias has been eliminated, but because action cannot wait for elimination.

## When neutrality becomes a refuge

Judgment becomes dangerous when neutrality is treated as the **standard** rather than the myth.

The committee that hides behind “the data speak for themselves” while choosing which data to admit. The leader who treats every dissent as bias and every agreement as proof. The professional who recommends nothing because nothing is certain enough to survive hindsight. Each is avoiding judgment by borrowing the costume of neutrality—either the neutrality of false completeness or the neutrality of permanent delay.
...
Compensation at the individual level is not willpower alone. It is **discipline**: seeking disconfirming views without pretending they cancel your own; documenting reasons before outcomes are known; building pause where the first coherent story wants to close; matching the strength of the claim to the strength of the evidence. The next chapters will take up decision under uncertainty and the perspectives we do not naturally possess. For now, notice the pattern: judgment **commits** from partial sight, and good judgment **widens** the sight it commits from—without claiming to have escaped it.

We attend from somewhere. We remember from somewhere. We interpret from somewhere. We trust from somewhere. We live inside structures built from somewhere. We also **judge** from somewhere—and the somewhere includes what we hope is true, what we fear repeating, and what we are willing to risk being wrong about in public.

Part I taught a way of asking: what problem did this mechanism solve, and what does it leave out? Part II must add a harder question: given what it leaves out, what do you still owe the person waiting on your answer?

Which opens the next pressure. Even honest judgment rarely enjoys certainty. Evidence arrives incomplete. Time runs out. Bodies and institutions do not wait for proof.
