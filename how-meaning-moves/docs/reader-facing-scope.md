...
- `how-meaning-moves/index.md`
- `how-meaning-moves/front-matter/**/*.md`
- `how-meaning-moves/parts/**/*.md`
- `how-meaning-moves/back-matter/**/*.md`

## Writer-facing paths

Treat these as writer-facing:

- `how-meaning-moves/docs/**/*.md`
...
rg -n 'docs/book-rules|docs/drafting-process|docs/typography-check|run pass|checklist|generated file|do not edit by hand|manuscript workflow' \
  how-meaning-moves/index.md \
  how-meaning-moves/front-matter \
  how-meaning-moves/parts \
  how-meaning-moves/back-matter
```
