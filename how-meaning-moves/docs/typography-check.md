...
GitHub Actions runs the same script on pull requests and pushes when files under `how-meaning-moves/` change (see `.github/workflows/how-meaning-moves-typography.yml`).
