...
describe("schema-version", () => {
  ...
  it("accepts schema 2.6 and compatibility 2.2–2.5; rejects major 3+", () => {
    ...
    expect(isCompatibleSchemaVersion("2.5")).toBe(true);
    expect(isCompatibleSchemaVersion("2.6")).toBe(true);
  ...
  it("identifies intended vs compatibility modes", () => {
    expect(isIntendedSchemaVersion("2.6")).toBe(true);
    expect(isIntendedSchemaVersion("2.7")).toBe(true);
    expect(isIntendedSchemaVersion("2.5")).toBe(false);
    expect(isIntendedSchemaVersion("2.4")).toBe(false);
    ...
    expect(isCompatibilitySchemaVersion("2.4")).toBe(true);
    expect(isCompatibilitySchemaVersion("2.5")).toBe(true);
    expect(isCompatibilitySchemaVersion("2.6")).toBe(false);
    expect(isSchemaAtLeast("2.6", INTENDED_SCHEMA_VERSION)).toBe(true);
    expect(
