...
describe("schema-version", () => {
  ...
  it("accepts schema 2.5 and compatibility 2.2–2.4; rejects major 3+", () => {
  ...
  it("identifies intended vs compatibility modes", () => {
    ...
    expect(isCompatibilitySchemaVersion("2.5")).toBe(false);
    expect(isSchemaAtLeast("2.5", INTENDED_SCHEMA_VERSION)).toBe(true);
    expect(
