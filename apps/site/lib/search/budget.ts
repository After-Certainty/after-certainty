 ...
 * full documents + aliasConfig + public chapter docs land near ~480 KB gzip
 * after World We Make Together source extract + NTTT/Case discovery).
 */
export const SEARCH_INDEX_GZIP_EXPECTED_MAX_BYTES = 480 * 1024;
