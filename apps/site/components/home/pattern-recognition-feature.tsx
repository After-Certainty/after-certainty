  ...
  return (
    ...
    >
      <Container>
        <TrackedLink
          href={href}
          className="group grid grid-cols-1 items-center gap-3 border border-border/50 bg-bg-elevated/40 px-4 py-5 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.04)] transition-colors hover:border-accent/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent min-[360px]:grid-cols-[minmax(0,0.28fr)_minmax(0,0.72fr)] min-[360px]:gap-3.5 md:gap-6 md:px-6 md:py-5"
        ...
        >
          <div className="relative mx-auto flex w-[5.25rem] shrink-0 items-center justify-center min-[360px]:mx-0 min-[360px]:w-full min-[360px]:max-w-[5.75rem] md:max-w-[6.5rem]">
            <Image
              ...
              sizes="(max-width: 359px) 84px, (max-width: 768px) 92px, 104px"
            />
          </div>
          <div className="min-w-0 text-left">
            ...
            <h2
              ...
              className="mt-2 font-display text-lg font-medium leading-[1.2] tracking-tight text-fg transition-colors group-hover:text-accent md:text-2xl md:leading-snug"
            >
            ...
            <span className="mt-3 inline-flex min-h-9 items-center text-[11px] uppercase tracking-[0.14em] text-accent transition-colors group-hover:text-fg min-[375px]:whitespace-nowrap md:text-xs md:tracking-[0.2em]">
              {linkText} →
            </span>
