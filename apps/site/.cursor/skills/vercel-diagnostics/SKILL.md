...
description: >-
  Runs Vercel CLI diagnostics for After Certainty via PADE v0.2.1 broker on
...
- Released **PADE v0.2.1** on `PATH` (from [`.cursor/install-pade.sh`](../../../../.cursor/install-pade.sh))
