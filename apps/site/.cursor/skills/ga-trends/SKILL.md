...
description: >-
  ...
  PADE v0.2.1 broker on Cursor Cloud Agents. Fallback: analytics MCP on local
...
- Released **PADE v0.2.1** on `PATH` (from [`.cursor/install-pade.sh`](../../../../.cursor/install-pade.sh) via [`.cursor/environment.json`](../../../../.cursor/environment.json))
