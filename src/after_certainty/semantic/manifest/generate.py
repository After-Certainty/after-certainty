...
from after_certainty.semantic.manifest.books import (
    build_book_entry,
    raw_content_url,
    resolve_repo_slug,
)
from after_certainty.semantic.manifest.cover_assets import (
    attach_cover_images_to_books,
    default_cover_assets_manifest_path,
    load_cover_assets_manifest,
)
from after_certainty.semantic.manifest.discovery import (
    attach_discovery_collections,
    enrich_book_discovery_fields,
)
from after_certainty.semantic.manifest.pattern_yaml import (
