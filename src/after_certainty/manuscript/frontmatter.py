...
Templates are rendered with Jinja2. Paths in book.yml `repo_template` are relative
to the repository root; ``{% include "..." %}`` resolves from that root as well.
"""
...
from after_certainty.specs.book_specs import load_any_book_spec, resolve_spec_path
