...
| **How Meaning Moves** — *Signal, Compression, Restraint, and the Pace of Understanding* | [`how-meaning-moves/index.md`](how-meaning-moves/index.md) | Why communication fails before anyone is “wrong”: signal, compression, and restraint between speakers and listeners. |
...
| **Velorum** — *A Tragic Mythic Fantasy Novel* | [`velorum/index.md`](velorum/index.md) | Mythic land, contemporary voice: Cael and Riven, the bond, Greyhaven, and what holding the world together costs. |
