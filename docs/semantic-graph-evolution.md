...
| `semantic/forces/` | Organizing forces (pattern languages) | `force-` |
...
Cross-corpus pattern language: [`docs/after-certainty-pattern-language.md`](after-certainty-pattern-language.md).
