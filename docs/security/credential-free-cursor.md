...
Google Analytics trend reports on **Cursor Cloud Agents** use [PADE v0.3.0](https://github.com/After-Certainty/pade/releases/tag/v0.3.0) and a private broker — not MCP or `gcloud` ADC on the agent VM.
