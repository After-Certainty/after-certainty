...
Google Analytics trend reports on **Cursor Cloud Agents** use [PADE v0.2.1](https://github.com/After-Certainty/pade/releases/tag/v0.2.1) and a private broker — not MCP or `gcloud` ADC on the agent VM.
