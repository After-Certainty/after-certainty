...
## Start here (by reader interest)

| If you want… | Start with |
|--------------|------------|
| Historical formation of moral order | [Before Certainty Arrives](../books/before-certainty-arrives/index.md) or [Curiosity Before Certainty](../books/curiosity-before-certainty/index.md) (published entry) |
...
| Communication and meaning | [How Meaning Moves](../books/how-meaning-moves/index.md) |
...
Velorum ([`books/velorum/`](../books/velorum/index.md)) and **The Relay** ([`books/the-relay/`](../books/the-relay/index.md)) are **fiction**—not part of the nonfiction ladder below.

---

## Upcoming nonfiction — suggested reading order
...
6. **[Why Collaboration Is So Hard](../books/why-collaboration-is-so-hard/index.md)** — coordination without full ownership  
...
### Historical / institutional arc (Tier A editorial)

| Book | One-line role |
|------|----------------|
| [Before Certainty Arrives](../books/before-certainty-arrives/index.md) | Moral order before certainty felt excessive—history, not self-help. |
| [When Accountability No Longer Expires](../books/when-accountability-no-longer-expires/index.md) | Why institutions keep legitimacy after harm—not villain profiles. |
| [After Certainty](../books/after-certainty/index.md) | How to live and judge after frameworks fail—capstone practice. |

### Judgment / alignment / compression

| Book | One-line role |
|------|----------------|
| When Interpretation No Longer Matters | Authority types when public understanding collapses. |
| When Incentives Become the Moral Language | Eight domains where metrics replaced judgment. |
| The Economy We Don't Experience | Lived economy vs aggregate narrative; credibility under pressure. |
| [After Certainty](../books/after-certainty/index.md) | Practice capstone—not another diagnosis of collapse. |
| [How Meaning Moves](../books/how-meaning-moves/index.md) (published) | How meaning moves between people—signal, compression, restraint. |

Echo checks: interpretation Part III–IV pass docs; incentives interlude; economy compression invariant.

### Coordination and judgment under pressure (depth pipeline)
...
**Before Arrives** (published essay): historical prequel—how moral order formed and hardened.  
**Curiosity** (published): contemporary posture when certainty fails.
...
When a book is promoted from `upcoming/` to `books/`, update links in this guide and add a “Related books” block on its `index.md` if missing.
