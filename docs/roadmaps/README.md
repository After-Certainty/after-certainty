...
| Path | Topic | Classification |
|------|-------|----------------|
| [`apps/site/docs/roadmaps/patterns-mobile-redesign.md`](../../apps/site/docs/roadmaps/patterns-mobile-redesign.md) | Patterns index + Pattern detail mobile UX redesign | **active-specialized-site-plan** (Phase 1 complete; Phases 2–6 pending) |
