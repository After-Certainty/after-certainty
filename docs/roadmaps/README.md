...
| Path | Topic | Classification |
|------|-------|----------------|
| [`apps/site/docs/roadmaps/patterns-mobile-redesign.md`](../../apps/site/docs/roadmaps/patterns-mobile-redesign.md) | Patterns index + Pattern detail mobile UX redesign | **active-specialized-site-plan** (planning complete; Phases 1–6 pending) |
