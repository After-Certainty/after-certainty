...
make reconcile-suno-playlist FIXTURE=tools/songs/fixtures/suno-playlist-2026-09-10.json

# Dry-run sync plan (+ optional fixture save)
make sync-suno-playlist FETCH=1 SAVE_FIXTURE=1 SNAPSHOT_DATE=2026-09-10

# Apply clip ID / order updates
make sync-suno-playlist-apply FETCH=1 SAVE_FIXTURE=1 SNAPSHOT_DATE=2026-09-10
make sync-suno-playlist-apply FIXTURE=tools/songs/fixtures/suno-playlist-2026-09-10.json SNAPSHOT_DATE=2026-09-10

# Direct Python
python3 tools/songs/reconcile_suno_playlist.py --fetch
python3 tools/songs/sync_suno_playlist.py --fetch --save-fixture --apply --snapshot-date 2026-09-10
```
